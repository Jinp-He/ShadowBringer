...
public class VisionCone : MonoBehaviour
{
	...
	[Header("Material")]
	public Material safe_material;
	public Material safe_far_material;
	public Material alert_material;
	public Material alert_far_material;
	public Material dangerous_material;
	...
	private void Awake()
	{
		cone_material = safe_material;
		cone_far_material = safe_far_material;
	...
	private void Update()
	{
		...
		switch (target.GetVisionState())
		{
			case VisionState.Safe:
				render.sharedMaterial = safe_material;
				render_far.sharedMaterial = safe_far_material;
				break;
			case VisionState.Alert:
				render.sharedMaterial = alert_material;
				render_far.sharedMaterial = alert_far_material;
				break;
			case VisionState.Danger:
				render.sharedMaterial = dangerous_material;
				render_far.sharedMaterial = dangerous_material;
				break;
		}
